    ...
    >
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-1">
          ...
          <div className="text-muted-foreground text-xs">{t(`status.${shipment.status.replace(/\s/g, "_")}`)}</div>
        </div>
      </div>
      ...
      <CardContent className="flex flex-1 flex-col gap-4 overflow-hidden px-0">
        ...
        <div className="px-4">
          <InputGroup className="h-8">
            <InputGroupInput className="h-8" aria-label={t("search_placeholder")} placeholder={t("search_placeholder")} />
            <InputGroupAddon>
              <Search />
            </InputGroupAddon>
          </InputGroup>
