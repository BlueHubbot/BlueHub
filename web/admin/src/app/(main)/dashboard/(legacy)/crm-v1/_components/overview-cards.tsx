    ...
    <div className="grid grid-cols-1 gap-4 *:data-[slot=card]:shadow-xs sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
      <Card>
        ...
        <CardFooter className="flex items-center justify-between">
          <span className="font-semibold text-xl">635</span>
      ...
      <Card className="overflow-hidden pb-0">
        <CardHeader>
          <CardTitle>{t("proposals_sent")}</CardTitle>
          <CardDescription>{t("last_month")}</CardDescription>
        </CardHeader>
      ...
      <Card>
        ...
        <CardContent className="flex size-full flex-col justify-between">
          ...
          <p className="font-medium text-2xl">$56,050</p>
      ...
      <Card>
        ...
        <CardContent className="flex size-full flex-col justify-between">
          <div className="space-y-1.5">
            <CardTitle>{t("projects_won")}</CardTitle>
            <CardDescription>{t("last_6_months")}</CardDescription>
          </div>
          <p className="font-medium text-2xl">136</p>
      ...
      <Card className="col-span-1 xl:col-span-2">
        <CardHeader>
          ...
          <CardDescription>{t("year_to_date")}</CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <CardFooter>
          <p className="text-muted-foreground text-sm">{t("growth_footer")}</p>
        </CardFooter>
      </Card>
    </div>
  );
