...
function DragHandle({ id }: { id: number }) {
  const t = useTranslations("Legacy.Default.table");
    ...
    <Drawer direction={isMobile ? "bottom" : "right"}>
      ...
      <DrawerContent>
        <DrawerHeader className="gap-1">
          ...
          <DrawerDescription>{t("detail_description")}</DrawerDescription>
        </DrawerHeader>
        <div className="flex flex-col gap-4 overflow-y-auto px-4 text-sm">
            ...
            <>
              ...
              <div className="grid gap-2">
                <div className="flex gap-2 font-medium leading-none">
                  {t("trending_up")} <TrendingUpIcon />
                </div>
                <div className="text-muted-foreground">{t("trending_description")}</div>
              </div>
              <Separator />
            </>
          )}
          <form className="flex flex-col gap-4">
            <div className="flex flex-col gap-3">
              <Label htmlFor="header">{t("header_label")}</Label>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col gap-3">
                ...
                <Select defaultValue={item.type}>
                  ...
                  <SelectContent>
                    <SelectGroup>
                      <SelectItem value="Table of Contents">{t("types.table_of_contents")}</SelectItem>
                      <SelectItem value="Executive Summary">{t("types.executive_summary")}</SelectItem>
                      <SelectItem value="Technical Approach">{t("types.technical_approach")}</SelectItem>
                      <SelectItem value="Design">{t("types.design")}</SelectItem>
                      <SelectItem value="Capabilities">{t("types.capabilities")}</SelectItem>
                      <SelectItem value="Focus Documents">{t("types.focus_documents")}</SelectItem>
                      <SelectItem value="Narrative">{t("types.narrative")}</SelectItem>
                      <SelectItem value="Cover Page">{t("types.cover_page")}</SelectItem>
                    </SelectGroup>
                  </SelectContent>
                </Select>
              </div>
                ...
                <Select defaultValue={item.status}>
                  ...
                  <SelectContent>
                    <SelectGroup>
                      ...
                      <SelectItem value="In Progress">{t("statuses.in_progress")}</SelectItem>
                      <SelectItem value="Not Started">{t("statuses.not_started")}</SelectItem>
                    </SelectGroup>
                  </SelectContent>
                </Select>
              </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col gap-3">
                <Label htmlFor="target">{t("target_label")}</Label>
            ...
            <div className="flex flex-col gap-3">
              <Label htmlFor="reviewer">{t("reviewer_label")}</Label>
          ...
          <>
            ...
            <Select>
              <SelectTrigger
                ...
                size="sm"
              >
                <SelectValue placeholder={t("assign_reviewer")} />
              </SelectTrigger>
