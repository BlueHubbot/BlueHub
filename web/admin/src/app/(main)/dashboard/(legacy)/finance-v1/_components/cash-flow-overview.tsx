...
export function CashFlowOverview() {
  const t = useTranslations("Legacy.Finance.cashflow");
          ...
          <Select defaultValue="this-year">
            ...
            <SelectContent>
              <SelectGroup>
                ...
                <SelectItem value="last-6-months">{t("periods.last_6_months")}</SelectItem>
                <SelectItem value="ytd">{t("periods.ytd")}</SelectItem>
                <SelectItem value="this-year">{t("periods.this_year")}</SelectItem>
              </SelectGroup>
            </SelectContent>
          </Select>
        </CardAction>
        ...
        <div className="flex items-start justify-between gap-2 py-5 md:items-stretch md:gap-0">
          <div className="flex flex-1 items-center justify-center gap-2">
            ...
            <div>
              ...
              <p className="font-medium">{formatCurrency(totalIncome, { noDecimals: true })}</p>
            </div>
          </div>
          ...
          <div className="flex flex-1 items-center justify-center gap-2">
            ...
            <div>
              ...
              <p className="font-medium">{formatCurrency(totalExpenses, { noDecimals: true })}</p>
            </div>
          </div>
        </div>
        <Separator />
