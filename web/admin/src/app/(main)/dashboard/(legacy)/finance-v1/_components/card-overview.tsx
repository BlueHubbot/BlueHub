...
export function CardOverview() {
  const t = useTranslations("Legacy.Finance.card");

  const upcomingPayments = [
    {
      id: 1,
      icon: Home,
      title: t("payments.rent"),
      amount: 1200,
      date: `${t("due_on")} ${format(addDays(now, 2), "do MMMM yyyy")}`,
    },
    {
      id: 2,
      icon: Zap,
      title: t("payments.electricity"),
      amount: 75,
      date: `${t("due_on")} ${format(addDays(now, 2), "do MMMM yyyy")}`,
    },
    {
      id: 3,
      icon: Sparkles,
      title: t("payments.chatgpt"),
      amount: 20,
      date: `${t("due_on")} ${format(addDays(now, 7), "do MMMM yyyy")}`,
    },
    {
      id: 4,
      icon: Receipt,
      title: t("payments.credit_card"),
      amount: 420,
      date: `${t("due_on")} ${format(addDays(now, 9), "do MMMM yyyy")}`,
    },
  ];
        ...
        <div className="space-y-4">
              ...
              <div className="flex items-end justify-between">
                <div className="space-y-2">
                  ...
                  <div className="flex gap-6">
                    <div>
                      <p className="text-[10px] text-primary-foreground/80 uppercase tracking-wider">{t("valid_thru")}</p>
          ...
          <div className="space-y-2 text-sm">
            <div className="flex items-center justify-between">
              ...
              <span className="font-medium">{t("card_type_virtual")}</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-muted-foreground">{t("billing_cycle")}</span>
              <span className="font-medium">{t("billing_cycle_value")}</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-muted-foreground">{t("card_limit")}</span>
          ...
          <div className="space-y-4">
            <h6 className="text-muted-foreground text-sm uppercase">{t("upcoming_payments")}</h6>
