  ...
  return [
    {
      ...
      cell: ({ row }) => (
        <div className="flex items-center justify-center">
          <Checkbox
            aria-label={t("select_user", { name: row.original.name })}
        ...
        <div className="text-right">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                aria-label={t("open_actions", { name: row.original.name })}
            ...
            <DropdownMenuContent align="end">
              <DropdownMenuItem>{t("actions.view_profile")}</DropdownMenuItem>
              <DropdownMenuItem>{t("actions.edit_user")}</DropdownMenuItem>
              <DropdownMenuItem>{t("actions.manage_team")}</DropdownMenuItem>
              <DropdownMenuItem>{t("actions.resend_invite")}</DropdownMenuItem>
              <DropdownMenuSeparator />
              <DropdownMenuItem variant="destructive">{t("actions.deactivate")}</DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
        </div>
      ),
