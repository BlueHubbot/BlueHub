    ...
    <Card>
      <CardHeader>
        ...
        <CardAction className="flex items-center gap-1">
          <Button aria-label={t("open_orders")} size="icon-sm" variant="outline">
            <ArrowUpRight />
          </Button>
          <Button aria-label={t("download_orders")} size="icon-sm" variant="outline">
            <Download />
          </Button>
      ...
      <CardContent className="flex flex-col gap-4 px-0">
        ...
        <div className="flex items-center justify-between gap-4 px-4 pb-1">
          <p className="text-muted-foreground text-sm">
            {t("viewing")} {visibleOrderCount} {t("out_of")} {orderCount.toLocaleString()} {t("orders")}
          </p>
