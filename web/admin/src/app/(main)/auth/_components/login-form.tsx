...
export function LoginForm() {
  ...
  const formSchema = z.object({
    email: z.string().email({ message: t("login.errors.invalid_email") }),
    password: z.string().min(6, { message: t("login.errors.password_min") }),
        ...
        <Controller
          ...
          render={({ field, fieldState }) => (
            <Field orientation="horizontal" data-invalid={fieldState.invalid} className="items-center gap-2">
              ...
              />
              <FieldContent>
                <FieldLabel htmlFor="login-remember" className="font-normal cursor-pointer select-none">
                  {t("login.remember_me")}
                </FieldLabel>
                {fieldState.invalid && <FieldError errors={[fieldState.error]} />}
              </FieldContent>
